...
int DoIt( int argc, char * argv[])
{
  ...
  typedef itk::VTKPolyDataToMesh<MeshType> MeshConverterType;
  typedef itk::TriangleMeshToBinaryImageFilter<MeshType,LabelImageType> MeshToImageConverterType;
  ...
  if(!filledModel)
    ...
    {
    typename MeshConverterType::Pointer meshConverter = MeshConverterType::New();
    typename MeshToImageConverterType::Pointer meshToImageConverter =
      MeshToImageConverterType::New();
    meshConverter->SetInput(polyData);
    meshToImageConverter->SetInput(meshConverter->GetOutput());
    meshToImageConverter->SetInfoImage(label);
    meshToImageConverter->Update();
    label = meshToImageConverter->GetOutput();
    }
